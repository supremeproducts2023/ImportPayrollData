...
namespace ImportDataPayroll
{
    class Program
    {
        ...
        public static void getMenu()
        {
            ...
            Console.WriteLine("225 NMRP_BM");
            Console.WriteLine("226 NMRP_BD");
            Console.WriteLine("227 NMRP_IRM");
            Console.WriteLine("228 NMRP_IRD");
            Console.WriteLine("229 NMRP_FM");
            Console.WriteLine("230 NMRP_FD");
            Console.WriteLine("231 NMRP_PM");
            Console.WriteLine("232 NMRP_PD");
            Console.WriteLine("233 NMRP_TM");
            Console.WriteLine("234 NMRP_TD");
            Console.WriteLine("235 NMRP_YM");
        ...
        public static void inputMenu()
        {
            ...
            switch (mudule)
            {
                ...
                case "225": MRP.Import_NMRP_BM(); break;
                case "226": MRP.Import_NMRP_BD(); break;
                case "227": MRP.Import_NMRP_IRM(); break;
                case "228": MRP.Import_NMRP_IRD(); break;
                case "229": MRP.Import_NMRP_FM(); break;
                ...
                case "234": MRP.Import_NMRP_TD(); break;
                case "235": MRP.Import_NMRP_YM(); break;
